...
The `0-data/` directory also contains `x64_step_6000.json`, the frozen
6,000-case native-observation corpus reused by the RQ3 performance evaluation.
It is not regenerated by `make x64-gen`.
