...
export_code
  ITreeSum ITree1 showfruit type eval evala evalb env1 count Tree1 Tree2 length nth
  array_update arr1 arr2 nat1 h h2 coord1 coord1' incX coord3 coord3' coord4 coord5
  coord6 coord8
  in Rust
