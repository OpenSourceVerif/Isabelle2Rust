...
export_code
  fof1 fof2 fof3 arith hof1 hoft0 hoft1 hoft2 hoft3 hoft4 hof2 map f1 l1 filter f2 l2
  fold foldr ff f4 f5 foldl MapReduce split0 split countword countwebpage mapper
  shuffword shuffwords shuffall shuff reducer news webpages0 webpages concat2 concat3
  concat2c concat3c concathello concat2c' concat3c' concat2' concat3' concat3'' add0
  add1 addxyz addxyz2 addxyz3
  in Rust
