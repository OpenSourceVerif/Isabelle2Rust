...
1. read the Isabelle-generated export:
   `test/sbpf/theory/stage1/bpf_generator/interp_test.ocaml`
...
are generated from `test/sbpf/theory/bpf_generator.thy` under
`test/sbpf/theory/stage1/bpf_generator/`.
