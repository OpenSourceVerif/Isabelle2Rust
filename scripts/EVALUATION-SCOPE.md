...
| RQ2 SBPF instruction agreement | 10 independent batches of 100,000 vectors | `../evaluation/scripts/rq2/run-sbpf-10x100k.sh` |
| RQ2 x64 agreement | 10 independent batches of 100,000 vectors | `../evaluation/scripts/rq2/run-x64-10x100k.sh`; currently Stage-1 only |
...
| RQ3 x64 runtime/allocation/ablations | X64-stepper | `../evaluation/scripts/rq3/run-x64.py` via `make x64-performance` |
