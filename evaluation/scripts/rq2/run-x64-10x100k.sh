...
data_dir="$repo_root/test/x64/x64-validation/0-data"
encoder_export="$repo_root/test/x64/theory/stage1/x64_generator_bigint/x64_encode"
stepper_export="$repo_root/test/x64/theory/stage1/x64_generator_bigint/x64_step_test"
