theory Function_Test
  imports HOL.Fun Main HOL.Real "Rust.Rust_Setup"
begin
...
export_code Pred minus_nat add1 fun1 fun2 fun3 fun4 fun5 suc pred suc2 pred2 f6 f7 g7 addi first second array_assn query arr1 arr2 arr3 arr4 getv update kvs1 kvs2 in Rust
